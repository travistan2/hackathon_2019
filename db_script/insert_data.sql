USE cad_db;
INSERT INTO announcement (type, text) VALUES ("Cancelled train","May I have your attention please on platform [platform_number]. We are sorry to announce that at [cancel_time] [operator] service to [destination] has been cancelled. This is due to [cancellation_reason]. [operator] apologises for any inconvenience caused.");
...
INSERT INTO announcement (type, text) VALUES ("Cancelled train","Your attention please on platform [platform_number]. We are sorry that the [cancel_time] [operator] service to [destination] has been cancelled. This is due to [cancellation_reason]. [operator] apologises for the inconvenience this may cause you.");
...
INSERT INTO announcement (type, text) VALUES ("Fast Train","Stand well back from the platform edge. The next train at platform [platform_number] does not stop here. Stand behind the yellow line.");
...
INSERT INTO announcement (type, text) VALUES ("Next train","The next train to [arrive_depart] platform [platform_number], will be the [arrive_depart_time] [operator] service to [destination]. Calling at [intermediate_station]. This train has [number_of_coach]. Train facility is at the [front_middle_rear] of the train.");
...
INSERT INTO announcement (type, text) VALUES ("Platform Alteration","This is a platform alteration! The [altered_time] [operator] service to [destination] will now depart from platform [platform_number].");
...
INSERT INTO announcement (type, text) VALUES ("Help Point Next Train Button","This station is [station]. The next train to arrive at [platform] in the direction of [next_station] and [terminal_station] will be the [arrive_depart_time] [operator] service to [destination].");
