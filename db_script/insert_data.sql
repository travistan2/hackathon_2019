USE cad_db;
INSERT INTO announcement (type, text) VALUES ("Cancelled train","May I have your attention please on [platform_number]. We are sorry to announce that at [cancel_time] [operator] service to [destination] has been cancelled. This is due to [cancellation_reason]. [operator] apologises for any inconvenience caused.");
INSERT INTO announcement (type, text) VALUES ("Cancelled train","The [cancel_time] [operator] service to [destination] has been cancelled. This is because of [cancellation_reason]. We are sorry that your journey will take longer than planned.");
INSERT INTO announcement (type, text) VALUES ("Cancelled train","Your attention please on [platform_number]. We are sorry that the [cancel_time] [operator] service to [destination] has been cancelled. This is due to [cancellation_reason]. [operator] apologises for the inconvenience this may cause you.");
...
INSERT INTO announcement (type, text) VALUES ("Fast Train","Stand well back from the platform edge. The next train at [platform_number] does not stop here. Stand behind the yellow line.");
...
INSERT INTO announcement (type, text) VALUES ("Luggage","A secure luggage safekeep facility is located at [location] to enable passengers to store their luggage.");
INSERT INTO announcement (type, text) VALUES ("Next fastest service","Passengers for [station], your next fastest direct service is now expected to be the [amount_of_time] to [destination] departing from [platform_number]");
INSERT INTO announcement (type, text) VALUES ("Next train","The next train to [arrive_depart] [platform_number], will be the [arrive_depart_time] [operator] service to [destination]. Calling at [intermediate_station]. This train has [number_of_coach]. Train facility is at the [front_middle_rear] of the train.");
...
INSERT INTO announcement (type, text) VALUES ("Platform Alteration","This is a platform alteration! The [altered_time] [operator] service to [destination] will now depart from [platform_number].");
INSERT INTO announcement (type, text) VALUES ("Platform Alteration","This is a platform change! The [altered_time] [operator] service to [destination] will now leave from [platform_number].");
INSERT INTO announcement (type, text) VALUES ("Security","Security personnel patrol this station 24 hours a day.");
...
INSERT INTO announcement (type, text) VALUES ("Short Platforms","Due to short platforms, passengers for [station] should board the [front_middle_rear] coach.");
INSERT INTO announcement (type, text) VALUES ("Short Platforms","Some stations have short platforms. If you are travelling to [station], you will need to travel in the [front_middle_rear] carriages of the train.");
INSERT INTO announcement (type, text) VALUES ("Short-formed train","This train has [number_of_coach] coaches. Please accept our apologies for the reduced number of coaches today.");
...
INSERT INTO announcement (type, text) VALUES ("Ticket Checks","Ticket checks are in operation at this station. Please have your ticket ready for inspection.");
...
INSERT INTO announcement (type, text) VALUES ("Door Locking","Please note, train doors will close in [arrive_depart_time] prior to departure.");
INSERT INTO announcement (type, text) VALUES ("Help Point Next Train Button","This station is [station]. The next train to arrive at [platform_name] in the direction of [next_station] and [terminal_station] will be the [arrive_depart_time] [operator] service to [destination].");
